 ...
 */
   ...
   //---------------------------------------------------------
	...
	//---------------------------------------------------------
  	...
  	//---------------------------------------------------------
		...
		$idFooter = $secure->session('siteData.id', 'int', false) ?? 0;
   ...
   //--------------------------------------------------------- 
		...
		$reqpmodif = "UPDATE ".$prefixRoot."footer SET text=:text, css=:css, components=:components, assets=:assets, styles=:styles WHERE idSite=:idFooter AND idLang=:idLang";
		...
		$respmodif->bindValue(':idFooter', $idFooter, PDO::PARAM_STR);
